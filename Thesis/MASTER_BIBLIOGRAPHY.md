...
> [!IMPORTANT]
> **Strict Alphabetical Ordering & $$\ge 2021$$ Publication Rule**: 
> All entries are strictly arranged in **alphabetical order (A–Z)** by the primary author's surname or institutional organization, and are published strictly in **2021 or newer** (2021–2026). Each index `[#]` is fixed and globally synchronized across all thesis chapters.
